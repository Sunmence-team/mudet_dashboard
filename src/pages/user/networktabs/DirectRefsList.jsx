                        ...
                        filteredData.map((item, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <td className="p-4 border-y border-black/10">{item?.user?.fullname || "-"}</td>
                                    <td className="p-4 border-y border-black/10">{item?.user?.username || "-"}</td>
                                    <td className="p-4 border-y border-black/10 capitalize">{item?.user?.plan?.name || "-"}</td>
                                    <td className="p-4 border-y border-black/10">{item?.user?.rank ? item?.user?.rank : "No rank" || "-"}</td>
