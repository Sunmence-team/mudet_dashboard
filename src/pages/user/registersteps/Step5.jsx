...
const Step5 = forwardRef(({ nextStep, formData = {}, updateFormData, setSubmitting }, ref) => {
  ...
  const completeRegistration = useCallback(
    async (pin) => {
      ...
      try {
        ...
        console.log("Successfully completed registration:", JSON.stringify(response.data, null, 2));
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    console.log("Step5 mounted with formData:", JSON.stringify(formData, null, 2));
  }, [formData]);
