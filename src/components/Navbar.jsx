        ...
        <div>
            <nav className='w-full bg-white flex items-center justify-between gap-6 lg:px-8 px-4 md:py-2 py-4 shadow-md'>
                <div className="flex w-[calc(100%-152px-24px)] items-center md:gap-6 gap-3">
                    ...
                    <img src={assets.logo} alt="Mudet_Logo" className='object-cover md:block hidden' />
            ...
            <nav className={`absolute top-0 left-0 z-999 w-full h-screen bg-tetiary flex flex-col items-center justify-between gap-6 px-4 py-6 shadow-md ${isOpen ? 'slide-in' : 'slide-out'}`}>
                <div className="flex flex-col h-[calc(100%-40px-24px)] w-full md:gap-6 gap-3">
                    <div className="flex flex-row-reverse items-center justify-between ">
                        ...
                        <img src={assets.logo} alt="Mudet_Logo" className='object-cover w-18 h-18' />
                    </div>
